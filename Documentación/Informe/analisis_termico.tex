\subsection{Analisis termico}

Por el transistor de paso, en el peor de los casis, va a tener una caida de $V_{SD} = V_{CC} - V_O = 9.5V - 5V = 4.5V$, y va a circular una corriente maxima de $I_{L} = 1.5A$, llegando a tener una $P_{C,MAX} = \SI{6.75}{\watt}$. Por ende es necesario realizar un analisis térmico y ver si requiere agregar un disipador en dicho transistor de paso:
