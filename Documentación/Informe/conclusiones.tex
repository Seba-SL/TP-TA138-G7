...
\begin{itemize}
	\item El rechazo de ripple de la fuente de alimentación no es bueno, y ronda valores de $1/2$.
	\item El valor de $V_{DO} = \SI{0.8}{V}$ es cercano al límite admisible, y podría ser mucho mejor para tecnología MOS, incluso de \SI{0.1}{V}.
...
\begin{itemize}
	...
	\item La eficiencia es muy buena para tratarse de un regulador lineal.
\end{itemize}
