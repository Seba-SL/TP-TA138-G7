...
\end{figure}
	...
	Todo diseño tiene sus desafíos, en este caso, al diseñar un circuito impreso se tiene como principal objetivo maximizar el rendimiento del circuito de forma eficiente.
	
	
	 Debe ser de tamaño óptimo para la implementación en el sistema completo y debe contar con las tecnológicas con la mejor relación rendimiento respecto al costo. 
