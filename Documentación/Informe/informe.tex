...
\end{center}
	...
	\begin{itemize}
		...
		\item Pistas de alimentación: 0.6 mm a 1 mm.
		\item Pistas de potencia (etapa de salida del LDO): $\geq$ 1 mm.
	\end{itemize}
...
%	El diseño multicapa presenta ventajas en términos de integridad de señal, menor ruido y mejor comportamiento térmico, a costa de un mayor costo de fabricación. Por otro lado, la PCB de dos capas resulta adecuada para prototipos y aplicaciones de menor exigencia.
	...
	A continuación en la tabla \ref{tab:parametros_pcb_LDO} se detallan los parámetros y características definidas para el diseño final, el cual se aprecia en el apéndice \ref{sec:apendice_PCB}.
	...
	\begin{table}[H]
		...
		\begin{tabular}{|l|c|}
			...
			Ancho de pista (alimentación) & 1 mm \\
			Ancho de pista (potencia) & 1 mm \\
			\hline
			
			Plano de masa & [Sí / No] \\
			Separación mínima de pistas & [completar] \\
			\hline
	...
	\begin{table}[H]
		\centering
		\caption{Clasificación de nodos y dimensionamiento de pistas}
		\label{tab:nodos_pistas}
		\renewcommand{\arraystretch}{1.2}
		\begin{tabular}{|l|c|c|}
			\hline
			\textbf{Nodo} & \textbf{Red} & \textbf{Ancho de pista [mm]} \\
			\hline
			
			Vin & Alimentación & 0.8 -- 1.0 \\
			Vref & Señal & 0.25 -- 0.4 \\
			Vref\_t & Señal & 0.25 -- 0.4 \\
			Vref\_c & Señal & 0.25 -- 0.4 \\
			V\_voltage & Señal & 0.25 -- 0.4 \\
			V\_current & Señal & 0.25 -- 0.4 \\
			V\_Rs & Señal & 0.25 -- 0.4 \\
			Salida (Vo) & Potencia & 1.0 -- 1.2 \\
			GND & Alimentación & [plano / $\geq$ 1.0] \\
			\hline
	...
	\begin{figure}[H]
		...
		\begin{subfigure}[t]{0.5\textwidth}
			\centering
			\includegraphics[width=\textwidth]{img/LDO/PCB_Diseño/pistas.png}
			\caption{Pistas}
		\end{subfigure}
		\hfill
