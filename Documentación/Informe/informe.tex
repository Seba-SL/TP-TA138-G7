...
$$v_{ref-c} = \alpha v_{ref} = v_{fmin} = I_{FBCK} \cdot R_s \cdot \frac{R2}{R1} \rightarrow \SI{0.8}{V},$$
entonces, 
...
$$v_{ref-c} = \alpha v_{ref} + \beta v_o = v_{fmax} = I_{max} \cdot R_s \cdot \frac{R2}{R1} \rightarrow \SI{3}{V},$$
que define
\begin{equation}
...
Notar que en este caso $f_A$, la ganancia del elemento realimentador, no
...
\end{figure}
	...
	\subsection{Limitador de corriente shunt}
	...
	Para nuestro valor de $R_s$, $I_{omax} \approx \SI{3.3}{A}$.
