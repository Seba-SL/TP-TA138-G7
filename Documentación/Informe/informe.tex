...
\end{figure}
	...
	Dado que el circuito es muy similar al lazo de tensión, se puede hacer una relación directa entre el nodo 1 y el nodo 3 del lazo de tensión, y el nodo 2 y 3 del lazo de tensión. De esta comparación, se deduce que el de mayor constante de tiempo es el nodo 1, y será el que se compensará.
...
%	El diseño multicapa presenta ventajas en términos de integridad de señal, menor ruido y mejor comportamiento térmico, a costa de un mayor costo de fabricación. Por otro lado, la PCB de dos capas resulta adecuada para prototipos y aplicaciones de menor exigencia.
	...
	\begin{equation}
		R_{eq} \approx \SI{1}{k\ohm} // (\SI{3}{k\ohm} +\SI{100}{\ohm} )
	\end{equation}
	...
	\begin{figure}[H]
		...
		\caption{Bode resultante de la medición de $T_A$. Notar el polo en $\SI{10}{k\hertz}<f<\SI{100}{k\hertz}$.}
		\label{fig:bode_corte_corriente}
	\end{figure}
	
	Finalmente, se simula, nuevamente para $R_L = \SI{2.5}{\ohm}$, $T_A$ para el lazo de corriente compensado. El resultado puede verse en la figura \ref{fig:bode_corriente_compensado}
