...
La construcción del dispositivo se divide en dos secciones, las mismas se aprecian en el esquema general de la figura \ref{fig:esquemageneral}: 

\begin{itemize}
	\item \textbf{Fuente Conmutada (Fuente switching)}: Encargada de regular la tensión de forma eficiente desde la fuente de energía hacia el regulador lineal.
	\item \textbf{Regulador Lineal (LDO)}: Sacrifica eficiencia a cambio de precisión y control. Interactúa de forma directa con la carga.
\end{itemize}
...
Un Regulador de Baja Caída o LDO (Low Dropout Regulator) es un regulador lineal de tensión diseñado para mantener una tensión de salida constante incluso cuando la diferencia entre la tensión de entrada y la de salida es muy pequeña.
...
Considerando el contexto se escoge el modelo \textbf{4905}. Es un transistor que no sobredimensiona en gran medida la capacidad del regulador, normalmente pensado para switching pero aun así apto para la tarea.
