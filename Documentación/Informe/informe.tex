...
\end{figure}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\linewidth]{"../../Simulación/Graficos en Python/LDO_Vcc_Vo"}
		\caption{}
		\label{fig:ldovccvo}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\linewidth]{"../../Simulación/Graficos en Python/LDO_regulacion_linea"}
		\caption{}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\linewidth]{"../../Simulación/Graficos en Python/LDO_regulacion_carga"}
		\caption{}
