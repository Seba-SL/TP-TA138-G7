...
\end{table}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.55\linewidth]{"../../Simulación/LDO/Graficos en Python/Capturas/LDO_Vcc_Vo"}
	...
	El lazo de tensión exhibe una respuesta de duración aproximada \SI{5}{\micro s}, con una excursión mínima. El lazo de corriente, sin embargo, es más lento, con una duración de respuesta dinámica mínima de \SI{25}{\micro s}.
