...
\begin{document}
	...
	En la entrega anterior se diseño un inductor apropiado mediante el método de diseño iterativo de Erickson, cuyas caracteristicas finales se encuentran en la tabla \ref{}. Para llevar a cabo la construcción del inductor 
	

	
\begin{figure}[H]
	\centering
	\includegraphics[width=0.35\linewidth]{img/diseño_inductor/nucleo_EE19}
