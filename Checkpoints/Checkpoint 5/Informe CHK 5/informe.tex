...
\subsection{Diseño de red \textit{Snubber}}
	...
	La regulación de línea caracteriza la capacidad del convertidor para mantener constante la tensión de salida frente a variaciones en la tensión de entrada, manteniendo constante la carga en este caso de $5 \, k\Omega$. Rápidamente se detecto un error en el rendimiento de la fuente, ya que la regulación comienza a partir de una entrada de 13 V, mayor a lo esperado en el diseño el cual regulaba para valores mas bajos llegando a cumplir el requerimiento del rango de entrada desde 12 V hasta 30 V. Por otra parte las mediciones se ven limitadas hasta un valor cercano a 24 V debido a limitación del instrumental utilizado en el laboratorio.
