...
\paragraph{Método de medición aproximado de valor}



\paragraph{Método saturación y valor}
Se realiza la medición \ref{fig: medicion_L_sat} observa la tensión sobre la resistencia de sensado $R_{sense}$ representativa de la corriente en el inductor, la corriente del inductor debe aumentar formando una rampa perfectamente lineal.

\begin{enumerate}
	\item Se fija una tensión continua relativamente baja (por ejemplo 5–20 V).
	\item Se excita el MOSFET con PWM de baja frecuencia (100 Hz a algunos kHz).
	\item Se utiliza un Ton suficientemente largo para que la corriente alcance distintos valores.
	\item Se mide la tensión sobre $R_{sense}$ 
	\item Se aumenta gradualmente: la tensión de alimentación, o el tiempo de conducción (Duty).
\end{enumerate}
​

Mientras la rampa siga siendo lineal, el núcleo trabaja en la zona lineal.

Cuando aparece curvatura, comenzó la saturación.
